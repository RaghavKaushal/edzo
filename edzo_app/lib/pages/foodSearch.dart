import 'package:edzo_app/pages/food_screen.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import '../services/searchservicefood.dart';
    ...
    child: GestureDetector(
      onTap: () {
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
            builder: (BuildContext context) => FoodScreen(
              carbo: carbo,
              fat: fat,
              kcal: kcal,
              protein: protein,
...
Widget sendData(data, BuildContext context) {
  var carbo = data['carbo'];
  var fat = data['fat'];
  var kcal = data['kcal'];
  var protein = data['protein'];
